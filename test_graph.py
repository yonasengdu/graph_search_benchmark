...
graph.addUndirectedEdge('b', 'c', 2, 2)
...
print(f"a: {graph.degree('a')}")
print(f"b: {graph.degree('b')}")
print(f"c: {graph.degree('c')}")
print(f"d: {graph.degree('d')}")
print(f"e: {graph.degree('e')}")
print(f"f: {graph.degree('f')}")


print("\nCalculating closeness centralities:\n")
print(f"closeness centrality of 'a': {graph.closenessCentrality('a')}")
print(f"closeness centrality of 'b': {graph.closenessCentrality('b')}")
print(f"closeness centrality of 'c': {graph.closenessCentrality('c')}")
print(f"closeness centrality of 'd': {graph.closenessCentrality('d')}")
print(f"closeness centrality of 'e': {graph.closenessCentrality('e')}")
print(f"closeness centrality of 'f': {graph.closenessCentrality('f')}")


print("\nCalculating eigenvalue centralities:\n")
print(f"a: {graph.eigenvalueCentrality('a')}")
print(f"b: {graph.eigenvalueCentrality('b')}")
print(f"c: {graph.eigenvalueCentrality('c')}")
print(f"d: {graph.eigenvalueCentrality('d')}")
print(f"e: {graph.eigenvalueCentrality('e')}")
print(f"f: {graph.eigenvalueCentrality('f')}")


print("\nCalculating katz centralities:\n")
print(f"a: {graph.katzCentrality('a')}")
print(f"b: {graph.katzCentrality('b')}")
print(f"c: {graph.katzCentrality('c')}")
print(f"d: {graph.katzCentrality('d')}")
print(f"e: {graph.katzCentrality('e')}")
print(f"f: {graph.katzCentrality('f')}")


print("\nCalculating page-rank centralities:\n")
print(f"a: {graph.pagerankCentrality('a')}")
print(f"b: {graph.pagerankCentrality('b')}")
print(f"c: {graph.pagerankCentrality('c')}")
print(f"d: {graph.pagerankCentrality('d')}")
print(f"e: {graph.pagerankCentrality('e')}")
print(f"f: {graph.pagerankCentrality('f')}")